# The Whole Sky, in Six Inks

*A short follow-up draft for Gears of Resistance / mbparks.com*
...
Under the paint there was a quiet rewrite. Four nearly identical strips is exactly the complexity creep my own standing rules warn about, so the anemograph's bespoke code became a single generic register renderer, and all four strips are now thin configurations of it: an ink, a scale, an engraving, and the occasional flourish like gust flicks or a stippled second trace. The harness grew to twenty-six tests, including one that watches the demo weather rain on schedule and siphon at midnight.

Every register shares the drum's cylindrical geometry, so the day lines fall in one unbroken vertical down the column. Pressure sagging, wind rising, humidity climbing, rain accumulating, sun dimming: a front is a single story told in six inks, and now you can read it top to bottom.

v1.2.0, GPL-3.0, at github.com/mbparks/WeatherStation.
